...
<div class="row">
	<div class="col-sm-12">
		...
		<!-- <a href="training.php"> -->
		<p><h3 class="col-sm-12 text-danger" style="text-align: center;">
				...
				** ผู้นำเสนอบทความสามารถชำระค่าลงทะเบียนแบบปกติ (On site) <br> ตั้งแต่บัดนี้จนถึงวันที่ 30 มิถุนายน 2560 เพื่อได้รับการตีพิมพ์ลง Proceeding
			</h3></p>
			<!-- </a> -->
			<!-- </marquee> -->
		</div>
